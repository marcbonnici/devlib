...
class Target(object):
    ...
    def execute(self, command, timeout=None, check_exit_code=True,
                as_root=False, will_succeed=False, strip_colors=True):
        return self.conn.execute(command, timeout=timeout, check_exit_code=check_exit_code,
               as_root=as_root, strip_colors=strip_colors, will_succeed=will_succeed)
